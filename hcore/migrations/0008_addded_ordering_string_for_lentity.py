...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lentity.ordering_string'
        db.add_column('hcore_lentity', 'ordering_string', orm['hcore.lentity:ordering_string'])
        
        # Changing field 'Station.creator'
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, null=True, to=orm['auth.User']))
        db.alter_column('hcore_station', 'creator_id', orm['hcore.station:creator'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Lentity.ordering_string'
        db.delete_column('hcore_lentity', 'ordering_string')
    ...
    models = {
        ...
        'hcore.station': {
            ...
            'maintainers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'overseers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['hcore.Person']", 'symmetrical': 'False'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gline.linestring'
        db.add_column('hcore_gline', 'linestring', self.gf('django.contrib.gis.db.models.fields.LineStringField')(null=True, blank=True), keep_default=False)

        # Adding field 'Garea.mpoly'
        db.add_column('hcore_garea', 'mpoly', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gline.linestring'
        db.delete_column('hcore_gline', 'linestring')

        # Deleting field 'Garea.mpoly'
        db.delete_column('hcore_garea', 'mpoly')

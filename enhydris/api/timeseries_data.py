"""Crappy old code for charts.

This is very old code that was created in order for the JavaScript charts to have access
to the timeseries data. It should be revised together with the charts themselves.
"""

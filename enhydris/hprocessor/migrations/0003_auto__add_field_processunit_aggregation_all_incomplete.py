...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProcessUnit.aggregation_all_incomplete'
        db.add_column('hprocessor_processunit', 'aggregation_all_incomplete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProcessUnit.aggregation_all_incomplete'
        db.delete_column('hprocessor_processunit', 'aggregation_all_incomplete')

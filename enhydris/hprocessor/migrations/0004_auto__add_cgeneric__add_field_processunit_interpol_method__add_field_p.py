...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CGeneric'
#        db.create_table('hcore_gentitygenericdata', (
#            ,
#        ))
#        db.send_create_signal('hprocessor', ['CGeneric'])

        # Adding field 'ProcessUnit.interpol_method'
        db.add_column('hprocessor_processunit', 'interpol_method', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'ProcessUnit.independent_column'
        db.add_column('hprocessor_processunit', 'independent_column', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ProcessUnit.dependent_column'
        db.add_column('hprocessor_processunit', 'dependent_column', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'ProcessUnit.curve'
        db.add_column('hprocessor_processunit', 'curve', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hcore.GentityGenericData'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CGeneric'
#        db.delete_table('hcore_gentitygenericdata')

        # Deleting field 'ProcessUnit.interpol_method'
        db.delete_column('hprocessor_processunit', 'interpol_method')

        # Deleting field 'ProcessUnit.independent_column'
        db.delete_column('hprocessor_processunit', 'independent_column')

        # Deleting field 'ProcessUnit.dependent_column'
        db.delete_column('hprocessor_processunit', 'dependent_column')

        # Deleting field 'ProcessUnit.curve'
        db.delete_column('hprocessor_processunit', 'curve_id')
    ...
    models = {
        ...
        'hprocessor.cgeneric': {
            'Meta': {'ordering': "['id']", 'object_name': 'CGeneric', 'db_table': "'hcore_gentitygenericdata'", '_ormbases': ['hcore.GentityGenericData'], 'proxy': 'True'}
        },
        ...
        'hprocessor.processunit': {
            ...
            'curve': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hcore.GentityGenericData']", 'null': 'True'}),
            ...
            'interpol_method': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('hprocessor', ['ProcessUnit'])

        # Adding model 'ProcessInputVariable'
        db.create_table('hprocessor_processinputvariable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('hprocessor', ['ProcessInputVariable'])


    def backwards(self, orm):
        
        # Deleting model 'ProcessBatch'
        db.delete_table('hprocessor_processbatch')

        # Deleting model 'ProcessUnit'
        db.delete_table('hprocessor_processunit')

        # Deleting model 'ProcessInputVariable'
        db.delete_table('hprocessor_processinputvariable')

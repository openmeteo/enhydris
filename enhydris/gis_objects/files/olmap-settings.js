...
var google_gphy = new OpenLayers.Layer.Google("Google Physical map", {isBaseLayer:true, type: google.maps.MapTypeId.TERRAIN});
var google_map = new OpenLayers.Layer.Google("Google Streets map", {isBaseLayer:true, numZoomLevels: 20});
var google_hyb = new OpenLayers.Layer.Google("Google Hybrid map", {isBaseLayer:true, numZoomLevels: 20, type: google.maps.MapTypeId.HYBRID});
var google_sat = new OpenLayers.Layer.Google("Google Satellite map", {isBaseLayer:true, numZoomLevels: 22, type: google.maps.MapTypeId.SATELLITE,
  projection: new OpenLayers.Projection("EPSG:900913"), maxExtent: bounds, maxResolution: 900});
...
var base_layers = [ocm, google_sat,google_map,google_hyb,google_gphy, osm, wms1_base];

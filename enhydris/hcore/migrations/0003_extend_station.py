...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Same problem as before. SQL file messes up everythin and we go around
        # the problem by the try/except clause
        
        # Adding ManyToManyField 'Station.maintainers'
        try:
            db.create_table('hcore_station_maintainers', (
                ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
                ('station', models.ForeignKey(orm.Station, null=False)),
                ('user', models.ForeignKey(orm['auth.User'], null=False))
            ))
        except:
            print "Station Many2Many field named \'maintainers\' already exists. Skipping..."
        
        # Adding field 'Station.creator'.
        try:
            db.add_column('hcore_station', 'creator', orm['hcore.station:creator'])
        except:
            print "Station field named \'creator\' already exists. Skipping..."
        
    
    
    def backwards(self, orm):
        
        # Dropping ManyToManyField 'Station.maintainers'
        db.delete_table('hcore_station_maintainers')
        
        # Deleting field 'Station.creator'
        db.delete_column('hcore_station', 'creator_id')

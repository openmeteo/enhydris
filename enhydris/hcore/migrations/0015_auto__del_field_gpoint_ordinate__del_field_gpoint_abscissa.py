...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Gpoint.ordinate'
        db.delete_column('hcore_gpoint', 'ordinate')

        # Deleting field 'Gpoint.abscissa'
        db.delete_column('hcore_gpoint', 'abscissa')


    def backwards(self, orm):
        
        # Adding field 'Gpoint.ordinate'
        db.add_column('hcore_gpoint', 'ordinate', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Gpoint.abscissa'
        db.add_column('hcore_gpoint', 'abscissa', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

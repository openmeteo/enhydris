...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Station.copyright_holder'
        db.add_column('hcore_station', 'copyright_holder', self.gf('django.db.models.fields.TextField')(default='copyright holder unset'), keep_default=False)

        # Adding field 'Station.copyright_years'
        db.add_column('hcore_station', 'copyright_years', self.gf('django.db.models.fields.CharField')(default='UnsetYears', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Station.copyright_holder'
        db.delete_column('hcore_station', 'copyright_holder')

        # Deleting field 'Station.copyright_years'
        db.delete_column('hcore_station', 'copyright_years')

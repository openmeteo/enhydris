...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GentityAltCode.original_id'
        db.add_column('hcore_gentityaltcode', 'original_id', orm['hcore.gentityaltcode:original_id'])
        ...
        # Adding field 'GentityEvent.original_id'
        db.add_column('hcore_gentityevent', 'original_id', orm['hcore.gentityevent:original_id'])
        ...
        # Adding field 'Gentity.original_id'
        db.add_column('hcore_gentity', 'original_id', orm['hcore.gentity:original_id'])
        ...
        # Adding field 'Lentity.original_id'
        db.add_column('hcore_lentity', 'original_id', orm['hcore.lentity:original_id'])
        ...
        # Adding field 'TimeZone.original_id'
        db.add_column('hcore_timezone', 'original_id', orm['hcore.timezone:original_id'])
        
        # Adding field 'Timeseries.original_id'
        db.add_column('hcore_timeseries', 'original_id', orm['hcore.timeseries:original_id'])
        
        # Adding field 'Overseer.original_id'
        db.add_column('hcore_overseer', 'original_id', orm['hcore.overseer:original_id'])
        
        # Adding field 'Gentity.original_site'
        db.add_column('hcore_gentity', 'original_site', orm['hcore.gentity:original_site'])
        
        # Adding field 'GentityFile.original_id'
        db.add_column('hcore_gentityfile', 'original_id', orm['hcore.gentityfile:original_id'])
        
        # Adding field 'Instrument.original_id'
        db.add_column('hcore_instrument', 'original_id', orm['hcore.instrument:original_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GentityAltCode.original_id'
        db.delete_column('hcore_gentityaltcode', 'original_id')
        ...
        # Deleting field 'GentityEvent.original_id'
        db.delete_column('hcore_gentityevent', 'original_id')
        ...
        # Deleting field 'Gentity.original_id'
        db.delete_column('hcore_gentity', 'original_id')
        ...
        # Deleting field 'Lentity.original_id'
        db.delete_column('hcore_lentity', 'original_id')
        ...
        # Deleting field 'TimeZone.original_id'
        db.delete_column('hcore_timezone', 'original_id')
        
        # Deleting field 'Timeseries.original_id'
        db.delete_column('hcore_timeseries', 'original_id')
        
        # Deleting field 'Overseer.original_id'
        db.delete_column('hcore_overseer', 'original_id')
        
        # Deleting field 'Gentity.original_site'
        db.delete_column('hcore_gentity', 'original_site')
        
        # Deleting field 'GentityFile.original_id'
        db.delete_column('hcore_gentityfile', 'original_id')
        
        # Deleting field 'Instrument.original_id'
        db.delete_column('hcore_instrument', 'original_id')
    ...
    models = {
        ...
        'hcore.eventtype': {
            ...
            'original_site': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'hcore.filetype': {
            'descr': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'descr_alt': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),

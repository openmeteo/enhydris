...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('hcore_intervaltype', (
            ('id', orm['hcore.intervaltype:id']),
            ('original_id', orm['hcore.intervaltype:original_id']),
            ('original_db', orm['hcore.intervaltype:original_db']),
            ('last_modified', orm['hcore.intervaltype:last_modified']),
            ('descr', orm['hcore.intervaltype:descr']),
            ('descr_alt', orm['hcore.intervaltype:descr_alt']),
            ('value', orm['hcore.intervaltype:value']),
        ))
        db.send_create_signal('hcore', ['IntervalType'])
        
        # Adding field 'Timeseries.interval_type'
        db.add_column('hcore_timeseries', 'interval_type', orm['hcore.timeseries:interval_type'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('hcore_intervaltype')
        
        # Deleting field 'Timeseries.interval_type'
        db.delete_column('hcore_timeseries', 'interval_type_id')

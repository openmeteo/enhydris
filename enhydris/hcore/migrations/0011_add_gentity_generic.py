...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('hcore_gentitygenericdata', (
            ('id', orm['hcore.gentitygenericdata:id']),
            ('original_id', orm['hcore.gentitygenericdata:original_id']),
            ('original_db', orm['hcore.gentitygenericdata:original_db']),
            ('last_modified', orm['hcore.gentitygenericdata:last_modified']),
            ('gentity', orm['hcore.gentitygenericdata:gentity']),
            ('descr', orm['hcore.gentitygenericdata:descr']),
            ('remarks', orm['hcore.gentitygenericdata:remarks']),
            ('descr_alt', orm['hcore.gentitygenericdata:descr_alt']),
            ('remarks_alt', orm['hcore.gentitygenericdata:remarks_alt']),
            ('content', orm['hcore.gentitygenericdata:content']),
            ('data_type', orm['hcore.gentitygenericdata:data_type']),
        ))
        db.send_create_signal('hcore', ['GentityGenericData'])
        
        # Adding model 'GentityGenericDataType'
        db.create_table('hcore_gentitygenericdatatype', (
            ('id', orm['hcore.gentitygenericdatatype:id']),
            ('original_id', orm['hcore.gentitygenericdatatype:original_id']),
            ('original_db', orm['hcore.gentitygenericdatatype:original_db']),
            ('last_modified', orm['hcore.gentitygenericdatatype:last_modified']),
            ('descr', orm['hcore.gentitygenericdatatype:descr']),
            ('descr_alt', orm['hcore.gentitygenericdatatype:descr_alt']),
            ('file_extension', orm['hcore.gentitygenericdatatype:file_extension']),
        ))
        db.send_create_signal('hcore', ['GentityGenericDataType'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('hcore_gentitygenericdatatype')

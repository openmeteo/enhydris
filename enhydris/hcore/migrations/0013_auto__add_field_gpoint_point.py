...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gpoint.point'
        db.add_column('hcore_gpoint', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Gpoint.point'
        db.delete_column('hcore_gpoint', 'point')

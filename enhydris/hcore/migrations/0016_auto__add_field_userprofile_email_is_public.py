...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.email_is_public'
        db.add_column('hcore_userprofile', 'email_is_public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.email_is_public'
        db.delete_column('hcore_userprofile', 'email_is_public')

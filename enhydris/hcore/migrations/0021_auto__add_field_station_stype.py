...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hcore_station_stype', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('station', models.ForeignKey(orm['hcore.station'], null=False)),
            ('stationtype', models.ForeignKey(orm['hcore.stationtype'], null=False))
        ))
        db.create_unique('hcore_station_stype', ['station_id', 'stationtype_id'])

        # Changing field 'Station.type'
        db.alter_column('hcore_station', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['hcore.StationType']))


    def backwards(self, orm):
        
        # Removing M2M table for field stype on 'Station'
        db.delete_table('hcore_station_stype')

        # Changing field 'Station.type'
        db.alter_column('hcore_station', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['hcore.StationType']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 18, 11, 35, 55, 509484)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 18, 11, 35, 55, 509386)'}),

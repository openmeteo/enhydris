...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OtherPlot'
        db.create_table('contourplot_otherplot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contourplot.ChartPage'])),
            ('sequence', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('rpage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rpage_set', to=orm['contourplot.ChartPage'])),
        ))
        db.send_create_signal('contourplot', ['OtherPlot'])

        # Adding unique constraint on 'OtherPlot', fields ['page', 'rpage']
        db.create_unique('contourplot_otherplot', ['page_id', 'rpage_id'])

        # Adding unique constraint on 'OtherPlot', fields ['page', 'sequence']
        db.create_unique('contourplot_otherplot', ['page_id', 'sequence'])

        # Adding field 'ChartPage.side_text'
        db.add_column('contourplot_chartpage', 'side_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'ChartPage.boundary_distance_factor'
        db.add_column('contourplot_chartpage', 'boundary_distance_factor', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'ChartPage.boundary_value'
        db.add_column('contourplot_chartpage', 'boundary_value', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'ChartPage.boundary_mode'
        db.add_column('contourplot_chartpage', 'boundary_mode', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'OtherPlot', fields ['page', 'sequence']
        db.delete_unique('contourplot_otherplot', ['page_id', 'sequence'])

        # Removing unique constraint on 'OtherPlot', fields ['page', 'rpage']
        db.delete_unique('contourplot_otherplot', ['page_id', 'rpage_id'])

        # Deleting model 'OtherPlot'
        db.delete_table('contourplot_otherplot')

        # Deleting field 'ChartPage.side_text'
        db.delete_column('contourplot_chartpage', 'side_text')

        # Deleting field 'ChartPage.boundary_distance_factor'
        db.delete_column('contourplot_chartpage', 'boundary_distance_factor')

        # Deleting field 'ChartPage.boundary_value'
        db.delete_column('contourplot_chartpage', 'boundary_value')

        # Deleting field 'ChartPage.boundary_mode'
        db.delete_column('contourplot_chartpage', 'boundary_mode')

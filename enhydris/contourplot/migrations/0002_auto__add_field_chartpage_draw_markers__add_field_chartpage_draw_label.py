...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.draw_markers'
        db.add_column('contourplot_chartpage', 'draw_markers', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ChartPage.draw_labels'
        db.add_column('contourplot_chartpage', 'draw_labels', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ChartPage.contours_font_size'
        db.add_column('contourplot_chartpage', 'contours_font_size', self.gf('django.db.models.fields.IntegerField')(default=8), keep_default=False)

        # Adding field 'ChartPage.labels_format'
        db.add_column('contourplot_chartpage', 'labels_format', self.gf('django.db.models.fields.CharField')(default='%1.0f', max_length=10), keep_default=False)

        # Adding field 'ChartPage.draw_contours'
        db.add_column('contourplot_chartpage', 'draw_contours', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ChartPage.labels_font_size'
        db.add_column('contourplot_chartpage', 'labels_font_size', self.gf('django.db.models.fields.IntegerField')(default=8), keep_default=False)

        # Adding field 'ChartPage.color_map'
        db.add_column('contourplot_chartpage', 'color_map', self.gf('django.db.models.fields.CharField')(default='winter', max_length=8), keep_default=False)

        # Adding field 'ChartPage.reverse_color_map'
        db.add_column('contourplot_chartpage', 'reverse_color_map', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ChartPage.text_color'
        db.add_column('contourplot_chartpage', 'text_color', self.gf('django.db.models.fields.CharField')(default='black', max_length=12), keep_default=False)

        # Adding field 'ChartPage.contours_color'
        db.add_column('contourplot_chartpage', 'contours_color', self.gf('django.db.models.fields.CharField')(default='red', max_length=12), keep_default=False)

        # Adding field 'ChartPage.markers_color'
        db.add_column('contourplot_chartpage', 'markers_color', self.gf('django.db.models.fields.CharField')(default='black', max_length=12), keep_default=False)

        # Adding field 'ChartPage.markers_style'
        db.add_column('contourplot_chartpage', 'markers_style', self.gf('django.db.models.fields.CharField')(default='x', max_length=3), keep_default=False)

        # Adding field 'ChartPage.granularity'
        db.add_column('contourplot_chartpage', 'granularity', self.gf('django.db.models.fields.FloatField')(default=50), keep_default=False)

        # Adding field 'ChartPage.compose_background'
        db.add_column('contourplot_chartpage', 'compose_background', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChartPage.background_image'
        db.add_column('contourplot_chartpage', 'background_image', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Adding field 'ChartPage.mask_image'
        db.add_column('contourplot_chartpage', 'mask_image', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Adding field 'ChartPage.compose_method'
        db.add_column('contourplot_chartpage', 'compose_method', self.gf('django.db.models.fields.CharField')(default='multiply', max_length=12), keep_default=False)

        # Adding field 'ChartPage.swap_bg_fg'
        db.add_column('contourplot_chartpage', 'swap_bg_fg', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChartPage.compose_alpha'
        db.add_column('contourplot_chartpage', 'compose_alpha', self.gf('django.db.models.fields.FloatField')(default=0.5), keep_default=False)

        # Adding field 'ChartPage.compose_offset'
        db.add_column('contourplot_chartpage', 'compose_offset', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'ChartPage.always_refresh'
        db.add_column('contourplot_chartpage', 'always_refresh', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChartPage.default_dimension'
        db.add_column('contourplot_chartpage', 'default_dimension', self.gf('django.db.models.fields.IntegerField')(default=480), keep_default=False)

        # Renaming column for 'ChartPage.time_step' to match new field type.
        db.rename_column('contourplot_chartpage', 'time_step', 'time_step_id')
        # Changing field 'ChartPage.time_step'
        db.alter_column('contourplot_chartpage', 'time_step_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hcore.TimeStep']))

        # Adding index on 'ChartPage', fields ['time_step']
        db.create_index('contourplot_chartpage', ['time_step_id'])

        # Deleting field 'CPoint.display_point_on_map'
        db.delete_column('contourplot_cpoint', 'display_point_on_map')

        # Deleting field 'CPoint.display_point_label'
        db.delete_column('contourplot_cpoint', 'display_point_label')


    def backwards(self, orm):
        
        # Removing index on 'ChartPage', fields ['time_step']
        db.delete_index('contourplot_chartpage', ['time_step_id'])

        # Deleting field 'ChartPage.draw_markers'
        db.delete_column('contourplot_chartpage', 'draw_markers')

        # Deleting field 'ChartPage.draw_labels'
        db.delete_column('contourplot_chartpage', 'draw_labels')

        # Deleting field 'ChartPage.contours_font_size'
        db.delete_column('contourplot_chartpage', 'contours_font_size')

        # Deleting field 'ChartPage.labels_format'
        db.delete_column('contourplot_chartpage', 'labels_format')

        # Deleting field 'ChartPage.draw_contours'
        db.delete_column('contourplot_chartpage', 'draw_contours')

        # Deleting field 'ChartPage.labels_font_size'
        db.delete_column('contourplot_chartpage', 'labels_font_size')

        # Deleting field 'ChartPage.color_map'
        db.delete_column('contourplot_chartpage', 'color_map')

        # Deleting field 'ChartPage.reverse_color_map'
        db.delete_column('contourplot_chartpage', 'reverse_color_map')

        # Deleting field 'ChartPage.text_color'
        db.delete_column('contourplot_chartpage', 'text_color')

        # Deleting field 'ChartPage.contours_color'
        db.delete_column('contourplot_chartpage', 'contours_color')

        # Deleting field 'ChartPage.markers_color'
        db.delete_column('contourplot_chartpage', 'markers_color')

        # Deleting field 'ChartPage.markers_style'
        db.delete_column('contourplot_chartpage', 'markers_style')

        # Deleting field 'ChartPage.granularity'
        db.delete_column('contourplot_chartpage', 'granularity')

        # Deleting field 'ChartPage.compose_background'
        db.delete_column('contourplot_chartpage', 'compose_background')

        # Deleting field 'ChartPage.background_image'
        db.delete_column('contourplot_chartpage', 'background_image')

        # Deleting field 'ChartPage.mask_image'
        db.delete_column('contourplot_chartpage', 'mask_image')

        # Deleting field 'ChartPage.compose_method'
        db.delete_column('contourplot_chartpage', 'compose_method')

        # Deleting field 'ChartPage.swap_bg_fg'
        db.delete_column('contourplot_chartpage', 'swap_bg_fg')

        # Deleting field 'ChartPage.compose_alpha'
        db.delete_column('contourplot_chartpage', 'compose_alpha')

        # Deleting field 'ChartPage.compose_offset'
        db.delete_column('contourplot_chartpage', 'compose_offset')

        # Deleting field 'ChartPage.always_refresh'
        db.delete_column('contourplot_chartpage', 'always_refresh')

        # Deleting field 'ChartPage.default_dimension'
        db.delete_column('contourplot_chartpage', 'default_dimension')

        # Renaming column for 'ChartPage.time_step' to match new field type.
        db.rename_column('contourplot_chartpage', 'time_step_id', 'time_step')
        # Changing field 'ChartPage.time_step'
        db.alter_column('contourplot_chartpage', 'time_step', self.gf('django.db.models.fields.IntegerField')())

        # Adding field 'CPoint.display_point_on_map'
        db.add_column('contourplot_cpoint', 'display_point_on_map', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'CPoint.display_point_label'
        db.add_column('contourplot_cpoint', 'display_point_label', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'contourplot.chartpage': {
            ...
            'granularity': ('django.db.models.fields.FloatField', [], {'default': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.data_available_after_x_minutes'
        db.add_column('contourplot_chartpage', 'data_available_after_x_minutes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ChartPage.utc_offset_minutes'
        db.add_column('contourplot_chartpage', 'utc_offset_minutes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChartPage.data_available_after_x_minutes'
        db.delete_column('contourplot_chartpage', 'data_available_after_x_minutes')

        # Deleting field 'ChartPage.utc_offset_minutes'
        db.delete_column('contourplot_chartpage', 'utc_offset_minutes')

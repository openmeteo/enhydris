...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.url_int_alias'
        db.add_column('hchartpages_chartpage', 'url_int_alias', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'ChartPage.url_int_alias'
        db.delete_column('hchartpages_chartpage', 'url_int_alias')
    ...
    models = {
        ...
        'hchartpages.chartpage': {
            ...
            'url_int_alias': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),

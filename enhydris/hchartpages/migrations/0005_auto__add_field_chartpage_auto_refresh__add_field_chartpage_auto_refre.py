...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.auto_refresh'
        db.add_column('hchartpages_chartpage', 'auto_refresh', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChartPage.auto_refresh_interval'
        db.add_column('hchartpages_chartpage', 'auto_refresh_interval', self.gf('django.db.models.fields.IntegerField')(default=300), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChartPage.auto_refresh'
        db.delete_column('hchartpages_chartpage', 'auto_refresh')

        # Deleting field 'ChartPage.auto_refresh_interval'
        db.delete_column('hchartpages_chartpage', 'auto_refresh_interval')
    ...
    models = {
        ...
        'hchartpages.chart': {
            ...
            'chart_page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chart_page'", 'to': "orm['hchartpages.ChartPage']"}),
        ...
        'hchartpages.ctimeseries': {
            'Meta': {'ordering': "['id']", 'object_name': 'CTimeseries', 'db_table': "'hcore_timeseries'", '_ormbases': ['hcore.Timeseries'], 'proxy': 'True'}
        },
        'hchartpages.variable': {
            'Meta': {'object_name': 'Variable'},
            'chart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hchartpages.Chart']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

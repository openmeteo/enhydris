...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ChartPage', fields ['url_int_alias']
        db.create_unique('hchartpages_chartpage', ['url_int_alias'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ChartPage', fields ['url_int_alias']
        db.delete_unique('hchartpages_chartpage', ['url_int_alias'])

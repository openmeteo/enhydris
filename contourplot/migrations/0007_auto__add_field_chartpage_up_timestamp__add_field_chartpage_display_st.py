...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.up_timestamp'
        db.add_column('contourplot_chartpage', 'up_timestamp', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ChartPage.display_station_values'
        db.add_column('contourplot_chartpage', 'display_station_values', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChartPage.up_timestamp'
        db.delete_column('contourplot_chartpage', 'up_timestamp')

        # Deleting field 'ChartPage.display_station_values'
        db.delete_column('contourplot_chartpage', 'display_station_values')

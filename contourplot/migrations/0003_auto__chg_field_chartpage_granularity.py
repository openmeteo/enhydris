...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChartPage.granularity'
        db.alter_column('contourplot_chartpage', 'granularity', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'ChartPage.granularity'
        db.alter_column('contourplot_chartpage', 'granularity', self.gf('django.db.models.fields.FloatField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.old_values_title'
        db.add_column('contourplot_chartpage', 'old_values_title', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)

        # Adding field 'ChartPage.old_values_main_value_title'
        db.add_column('contourplot_chartpage', 'old_values_main_value_title', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'ChartPage.old_values_secondary_value_title'
        db.add_column('contourplot_chartpage', 'old_values_secondary_value_title', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'ChartPage.old_values_date_format'
        db.add_column('contourplot_chartpage', 'old_values_date_format', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChartPage.old_values_title'
        db.delete_column('contourplot_chartpage', 'old_values_title')

        # Deleting field 'ChartPage.old_values_main_value_title'
        db.delete_column('contourplot_chartpage', 'old_values_main_value_title')

        # Deleting field 'ChartPage.old_values_secondary_value_title'
        db.delete_column('contourplot_chartpage', 'old_values_secondary_value_title')

        # Deleting field 'ChartPage.old_values_date_format'
        db.delete_column('contourplot_chartpage', 'old_values_date_format')
    ...
    models = {
        ...
        'contourplot.chartpage': {
            ...
            'display_station_old_values': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'display_station_values': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'old_values_date_format': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'old_values_main_value_title': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'old_values_secondary_value_title': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'old_values_step_minutes': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'old_values_step_months': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'old_values_title': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
            ...
            'up_timestamp': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'contourplot.cpoint': {
            ...
            'secondary_timeseries': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'variable_2nd_Timeseries'", 'null': 'True', 'to': "orm['hcore.Timeseries']"}),

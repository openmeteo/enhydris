...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contourplot_chartpage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('url_name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
            ('chart_bounds_bl_x', self.gf('django.db.models.fields.FloatField')()),
            ('chart_bounds_bl_y', self.gf('django.db.models.fields.FloatField')()),
            ('chart_bounds_tr_x', self.gf('django.db.models.fields.FloatField')()),
            ('chart_bounds_tr_y', self.gf('django.db.models.fields.FloatField')()),
            ('chart_bounds_srid', self.gf('django.db.models.fields.IntegerField')(default=4326)),
            ('show_mean_value', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('time_step', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('ts_offset_minutes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('ts_offset_months', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('contourplot', ['ChartPage'])

        # Adding model 'CPoint'
        db.create_table('contourplot_cpoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cpoint_gpoint', to=orm['hcore.Gpoint'])),
            ('timeseries', self.gf('django.db.models.fields.related.ForeignKey')(related_name='variable_timeseries', to=orm['hcore.Timeseries'])),
            ('chart_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contourplot.ChartPage'])),
            ('weight', self.gf('django.db.models.fields.FloatField')(default=1)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('display_point_on_map', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_point_label', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('contourplot', ['CPoint'])


    def backwards(self, orm):
        
        # Deleting model 'ChartPage'
        db.delete_table('contourplot_chartpage')

        # Deleting model 'CPoint'
        db.delete_table('contourplot_cpoint')
    ...
    models = {
        ...
        'contourplot.chartpage': {
            ...
            'chart_bounds_srid': ('django.db.models.fields.IntegerField', [], {'default': '4326'}),
            ...
            'time_step': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            ...
            'url_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'})
        },
        'contourplot.cpoint': {
            ...
            'display_point_label': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'display_point_on_map': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'dbsync.database': {
            ...
            'hostname': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hcore.station': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_stations'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),
            'end_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'maintainers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'maintaining_stations'", 'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"}),

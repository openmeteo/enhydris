...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChartPage.display_station_old_values'
        db.add_column('contourplot_chartpage', 'display_station_old_values', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ChartPage.old_values_step_minutes'
        db.add_column('contourplot_chartpage', 'old_values_step_minutes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ChartPage.old_values_step_months'
        db.add_column('contourplot_chartpage', 'old_values_step_months', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CPoint.secondary_timeseries'
        db.add_column('contourplot_cpoint', 'secondary_timeseries', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='variable_2nd_Timeseries', null=True, to=orm['hcore.Timeseries']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChartPage.display_station_old_values'
        db.delete_column('contourplot_chartpage', 'display_station_old_values')

        # Deleting field 'ChartPage.old_values_step_minutes'
        db.delete_column('contourplot_chartpage', 'old_values_step_minutes')

        # Deleting field 'ChartPage.old_values_step_months'
        db.delete_column('contourplot_chartpage', 'old_values_step_months')

        # Deleting field 'CPoint.secondary_timeseries'
        db.delete_column('contourplot_cpoint', 'secondary_timeseries_id')

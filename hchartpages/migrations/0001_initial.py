...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hchartpages_chartpage', (
        ...
        db.send_create_signal('hchartpages', ['ChartPage'])

        # Adding model 'Chart'
        db.create_table('hchartpages_chart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ...
        db.send_create_signal('hchartpages', ['Chart'])

        # Adding model 'Variable'
        db.create_table('hchartpages_variable', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('hchartpages', ['Variable'])


    def backwards(self, orm):
        
        # Deleting model 'ChartPage'
        db.delete_table('hchartpages_chartpage')

        # Deleting model 'Chart'
        db.delete_table('hchartpages_chart')

        # Deleting model 'Variable'
        db.delete_table('hchartpages_variable')

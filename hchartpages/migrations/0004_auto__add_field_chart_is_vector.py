...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chart.is_vector'
        db.add_column('hchartpages_chart', 'is_vector', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chart.is_vector'
        db.delete_column('hchartpages_chart', 'is_vector')
